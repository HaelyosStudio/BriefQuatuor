...
(UUID_TO_BIN(UUID(), 1), 'Smith', 'Alice', 1, '$2y$10$Yx5b2bFsXPHyNDaNV4U0y.2LxtZiEx9bP.dJ6J8brC3QSe5zxFd8a', 'alice.smith@example.com', 2), -- Mot de passe en clair : alicepass
(UUID_TO_BIN(UUID(), 1), 'Garcia', 'Pedro', 0, '', 'pedro.garcia@example.com', 3),
(UUID_TO_BIN(UUID(), 1), 'Müller', 'Hans', 1, '$2y$10$aSXK5BeDgqbnXnLM5dLNq.JZDlbgAGAibCInSZ93cVLMdZr5b2SZq', 'hans.muller@example.com', 4), -- Mot de passe en clair : secret123
(UUID_TO_BIN(UUID(), 1), 'Chen', 'Li', 1, '$2y$10$2ClZ74v2noLgqqxyEK8zYuhjCRn54DQ0pTZMVNY7eZ8Tiz.ZiA9JG', 'li.chen@example.com', 5), -- Mot de passe en clair : p@ssw0rd
